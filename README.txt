...
- for_manuscript folder: This folder stores all figures for the manuscript and supplementary, as well as an Excel file, namely "SDG_Data" summarized all the results from this work. 

- verification folder: This folder contains R script and data was used in this study.
